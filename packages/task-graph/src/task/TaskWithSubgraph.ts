...
> extends Task<RunInput, RunOutput, Config> {
  // ========================================================================
   ...
   */
  declare _runner: TaskWithSubgraphRunner<RunInput, RunOutput, Config>;

  override get runner(): TaskWithSubgraphRunner<RunInput, RunOutput, Config> {
    if (!this._runner) {
      this._runner = new TaskWithSubgraphRunner<RunInput, RunOutput, Config>(this);
    }
    return this._runner;
  }
